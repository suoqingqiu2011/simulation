...
int new_cell=0;
while(t_clock<amount){  //amount=10000 est defini a la tete ds 'depot_excel.c'
    printf("\n--------------\n");
   ...
   case 0  :
    ...
    case 5 :
      ...
      next_red=floor(1/freq_red);
      next_green--;
      next_cell=floor(loi_hpexp(a,15,1)*1000);  //1000? => pour transformer en un "temps" ¨¤ l'echelle de la clock (en int positif quoi)
      printf("case 5\n");
      t_clock++;
      goto there;
