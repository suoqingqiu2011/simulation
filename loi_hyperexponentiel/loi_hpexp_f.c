...
float loi_hpexp(float *a,int size,int nb_excution){ //size = taille du tableau a
    int i;
    //float lamda[]={0.25,0.3,0.35,0.4,0.45,0.5,0.55,0.6,0.65,0.7,0.75}; //param¨¨tres de ces lois exponentielles
    float lamda[]={40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0,40.0}; //param¨¨tres de ces lois exponentielles
